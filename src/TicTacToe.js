  ...
  return gameState === GAME_STATES.notStarted ? (
    <Screen>
      <Inner>
        ...
        <select onChange={changeMode} value={mode} style={{fontFamily:"Reggae One"}}>
      ...
      <Inner>
        ...
        <ButtonRow>
          <button style={{height:"6vh", width:"6vh", marginLeft:"-1vh", fontFamily:"Reggae One", fontSize:"3vh"}} onClick={() => choosePlayer(PLAYER_X)}>X</button>
          <p>or</p>
          <button style={{height:"6vh", width:"6vh", marginRight:"-1vh", fontFamily:"Reggae One", fontSize:"3vh"}} onClick={() => choosePlayer(PLAYER_O)}>O</button>
        </ButtonRow>
      </Inner>
    </Screen>
  ) : (
    <Container dims={DIMS}>
      ...
      />
      <button onClick={startNewGame} style={{marginTop:"4vh", fontFamily:"Reggae One", fontSize:"1.5vh"}}>Reset</button>
      <ResultModal
        isOpen={modalOpen}
        winner={winner}
